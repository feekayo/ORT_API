...
class Model_accounts extends CI_Model{
    ...
    public function get_voice_num($user_id){
    
        $query = $this->db->query("SELECT post_id FROM ort_posts WHERE user_id='$user_id'");
    ...
    public function get_user_likes_num($user_id){
    
        $query = $this->db->query("SELECT track_id FROM ort_likes WHERE user_id='$user_id'");
    ...
    public function add_comment_track($track_id){
        ...
        if($query){
            $this->db->query("UPDATE ort_tracks SET comments_num=comments_num+1 WHERE track_id='$track_id'");
            return true;
        }else return false;
        
    }
    
    public function user_owns_comment($user_id,$comment_id){
        
        $query = $this->db->query("SELECT * FROM ort_comments WHERE comment_id='$comment_id' AND user_id='$user_id'");
    ...
    public function delete_comment($user_id,$comment_id,$track_id){
        $query = $this->db->query("DELETE FROM ort_comments WHERE comment_id='$comment_id' AND user_id='$user_id'");
        
        if($query){
            $query = $this->db->query("UPDATE ort_tracks SET comments_num=comments_num-1 WHERE track_id='$track_id'");
            return true;            
        }else return false;
    }
